  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        survival: {
          DEFAULT: "hsl(var(--survival-background))",
          card: "hsl(var(--survival-card))",
          border: "hsl(var(--survival-border))",
          primary: "hsl(var(--survival-primary))",
          secondary: "hsl(var(--survival-secondary))",
          ...
          accent: "hsl(var(--survival-accent))",
        },
        prosperity: {
          DEFAULT: "hsl(var(--prosperity-background))",
          card: "hsl(var(--prosperity-card))",
          border: "hsl(var(--prosperity-border))",
          primary: "hsl(var(--prosperity-primary))",
          secondary: "hsl(var(--prosperity-secondary))",
          accent: "hsl(var(--prosperity-accent))",
          muted: "hsl(var(--prosperity-muted))",
          gold: "hsl(var(--prosperity-gold))",
          emerald: "hsl(var(--prosperity-emerald))",
        },
      },
      fontFamily: {
