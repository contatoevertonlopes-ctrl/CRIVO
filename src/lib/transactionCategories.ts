...
export const DEFAULT_TRANSACTION_CATEGORIES: TransactionCategory[] = [
  ...
  { id: "impostos", name: "Impostos", icon: "percent", color: "#FDBA74", isDefault: true },
  { id: "investimentos", name: "Investimentos", icon: "landmark", color: "#F9A8D4", isDefault: true },
  { id: "lazer", name: "Lazer", icon: "sparkles", color: "#A3E635", isDefault: true },
  ...
  { id: "presentes", name: "Presentes", icon: "gift", color: "#60A5FA", isDefault: true },
