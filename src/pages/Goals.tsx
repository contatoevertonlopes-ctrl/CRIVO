          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[1, 2, 3].map((i) => (
                <div 
                  key={i} 
                  className="rounded-2xl border border-border/70 glass-card p-5 animate-pulse card-shadow-soft"
                >
            ...
            <div className="rounded-2xl border border-border/70 glass-card p-8 text-center card-shadow-soft">
              <div className={cn(
